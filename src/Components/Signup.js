    ...
    <div className="container">
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input type="password" className="form-control" autoComplete="current-password" id="password" name='password' onChange={onChange} minLength={5} required/>
        </div>
        <div className="mb-3">
          <label htmlFor="cpassword" className="form-label">Confrim Password</label>
          <input type="password" className="form-control" autoComplete="current-password" id="cpassword" name='cpassword' onChange={onChange} minLength={5} required/>
        </div>
